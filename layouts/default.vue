  ...
  <div>
    ...
    <div class="lg:pl-72">
      <div
        ...
        <p class="font-semibold"> MedDoc Parser</p>
          ...
          <div class="flex items-center gap-x-4 lg:gap-x-6">
            ...
            <Menu as="div" class="relative">
              <MenuButton class="-m-1.5 flex items-center p-1.5">
                ...
                <img class="h-8 w-8 rounded-full bg-gray-50" :src="currentUser.avatar" alt=""
                  referrerpolicy="no-referrer" />
                <span class="hidden lg:flex lg:items-center">
                  <span class="ml-4 text-sm font-semibold leading-6 text-gray-900" aria-hidden="true">{{ currentUser.name
                  }}</span>
              ...
              <transition enter-active-class="transition ease-out duration-100"
                ...
                <MenuItems
                  ...
                  <MenuItem v-if="currentUser.status" v-for="item in userNavigation" :key="item.name" v-slot="{ active }">
                    <a v-if="item.name == 'Sign out'" @click="signout" :href="item.href"
