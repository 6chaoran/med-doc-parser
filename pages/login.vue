...
<template>
    ...
    <div class="flex min-h-full flex-1 flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div class="sm:mx-auto sm:w-full sm:max-w-md">
        <img class="mx-auto h-20 w-auto rounded-full" src="/images.jfif" alt="Your Company" />
      ...
      <div class="sm:mx-auto sm:w-full sm:max-w-[480px]">
        <div class="bg-white px-6 py-12 shadow sm:rounded-lg sm:px-12">
          ...
          <div>
            ...
            <div class="mt-6 grid grid-cols-2 gap-4">
              <a @click="signInWithGoogle" class="flex w-full items-center justify-center gap-3 rounded-md bg-[#FFFFFF] border-gray border-[1px] px-3 py-1.5 text-black">
        ...
        <p class="mt-10 text-center text-sm text-gray-500">
          Not a member?
          {{ ' ' }}
          <a @click="signUpWithPassword" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Sign up from here</a>
        </p>
      </div>
    </div>
  </template>
